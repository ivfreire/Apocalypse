...
struct Vector2 {
	...
	float get(Axis axis) { if (axis == Axis::HORIZONTAL) return this->x; if (axis == Axis::VERTICAL) return this->y; }
	...
	Vector2 unit() { Vector2 uni; uni.set(this->x, this->y); uni.scale(1 / uni.module()); return uni; }
};
